      ...
      >
        ...
        <motion.div className="right" variants={item}>
          ...
          <motion.p className="st-text" variants={item}>
            Shadows creep from another dimension, consuming everything in their
            path. Unravel the mystery and face the darkness head-on. Will you
            survive the terror of the Upside Down?
          </motion.p>
        </motion.div>
      </motion.div>
